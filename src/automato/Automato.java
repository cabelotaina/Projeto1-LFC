...
public class Automato extends Regular {
	 ...
	 * 
	 * @param automato	AF que sera parcialmente clonado.
	 */
	...
	public Automato(ArrayList<Character> alfabeto){
		this(new ArrayList<>(), new ArrayList<>(alfabeto), 
				new Transicoes(), null, new ArrayList<>(), "", "");
	}
	 ...
	 * 
	 * @param estados			estados do AF.
	 * @param alfabeto			alfabeto do AF.
	 * @param transicoes		transicoes do AF.
	 * @param estadosIniciais	estado inicial do AF.
	 * @param estadosFinais		estados finais do AF.
	...
	public Automato(ArrayList<Estado> estados, ArrayList<Character> alfabeto,
			Transicoes transicoes, Estado estadosIniciais,
			ArrayList<Estado> estadosFinais, String titulo, String extras) {
		super();
	...
	public void setStates(ArrayList<Estado> estados) {
		this.estados = estados;
	}
	 ...
	 * 
	 * @param nome		nome do estado a ser encontrado.
	 ...
	 * estados do mesmo.
	 * 
	 * @param estado		Estado a ser adicionado ao AF.
	 */
	 ...
	 * 
	 * @param estados	Estados a serem adicionados.
	 */
	public void addStates(ArrayList<Estado> estados){
		for(Estado estado : estados)
	 ...
	 * 
	 * @param estado		Estado para verificação.
	 ...
	 * 
	 * @param simbolo	Simbolo a ser removido.
	 */
	...
	/**
	 * Adiciona uma nova transicoes ao AF 
	 * verificando se o estado current e o simbolo
	 * trigger ja existem no AF.
	 * 
	 * @param corrente		Estado 'corrente' da transicao.	
	 * @param disparador		Simbolo 'disparador' da transicao.
	 * @param alvo			Estado 'alvo' do disparo da transicao.
	 */
	public void adicionarTransicao(Estado corrente, char disparador, Estado alvo){
		if(!estados.contains(corrente) || 
	 ...
	 * 
	 * @param transicoes		Transicoes a serem adicionadas.
	 */
	 ...
	 * 
	 * @param estado			Estado que se quer achar o &-fecho.
	 * @param lista		Lista que ira conter o &-fecho do 1* estado chamado pela funcao.
	 */
	...
	/**
	 * Retorna a lista de estados alcancaveis por um estado
	 * 'corrente' com um simbolo 'disparador'.
	 * 
	 * @param atual		Estado 'corrente'.
	 * @param disparador		Simbolo 'disparador'.
	...
	/**
	 * Retorna a lista de estados alcacaveis por um estado
	...
	/**
	 * Troca todas as transicoes que levam ao estado 'estado_antigo' 
	 * para que levem agora para o estado 'estado_novo'.
	 * 
	 * @param estado_antigo		Estado ira perder as transicoes que levem  a ele.
	 * @param estado_novo		Estado que ira ganhar as transicoes para ele.
	 */
	...
	public void estadoInicial(Estado startingState) {
	 ...
	 * 
	 * @param estado		Estado a ser adicionado a lista.
	 */
	public void estadoFinal(Estado estado){
	 ...
	 * estados finais do AF.
	 * 
	 * @param estados	Lista de estados a ser adicionado.
	 */
	public void adicinarEstadosFinais(ArrayList<Estado> estados){
	 ...
	 * 
	 * @param estado		Estado que se quer verificar.
	 ...
	 * e transicoes deste automato.
	 * 
	 * @param nomeDeEstadosUnicos		Para deixar os estados do clone com nomes unicos
	...
	public Automato clone(boolean nomeDeEstadosUnicos) {
		...
		for(Estado estado : estados){
			...
			if(ehEstadoFinal(estado))
				novo_automato.estadoFinal(tmp);
			if(estadoInicial.equals(estado))
				novo_automato.estadoInicial(tmp);
